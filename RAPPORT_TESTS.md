...
**Résultat : 253 tests PC réussis ; 23 fichiers Python compilés avec succès.**
...
- 253 tests unitaires et d'intégration simulée (voir sortie ci-dessous) :
  223 pour le firmware, 30 pour le compagnon Windows.
