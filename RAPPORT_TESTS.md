...
**Résultat : 258 tests PC réussis ; 23 fichiers Python compilés avec succès.**
...
- 258 tests unitaires et d'intégration simulée (voir sortie ci-dessous) :
  228 pour le firmware, 30 pour le compagnon Windows.
