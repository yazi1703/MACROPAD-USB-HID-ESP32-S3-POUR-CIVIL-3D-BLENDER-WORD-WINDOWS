...
**Résultat : 101 tests PC réussis ; 21 fichiers Python compilés avec succès.**
...
- 101 tests unitaires et d'intégration simulée (voir sortie ci-dessous) :
  83 pour le firmware, 18 pour le compagnon Windows.
