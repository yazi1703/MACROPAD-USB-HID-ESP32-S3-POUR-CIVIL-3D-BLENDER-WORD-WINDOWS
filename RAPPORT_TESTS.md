...
**Résultat : 108 tests PC réussis ; 21 fichiers Python compilés avec succès.**
...
- 108 tests unitaires et d'intégration simulée (voir sortie ci-dessous) :
  83 pour le firmware, 25 pour le compagnon Windows.
